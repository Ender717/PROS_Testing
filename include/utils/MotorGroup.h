...
private:
     ...
     */
    double bindPower(double power);

    /**
     * Binds a voltage to a valid range
     * @param voltage The input voltage
     * @return The voltage bound from (-12000, 12000)
     */
    double bindVoltage(double voltage);

    /**
     * Binds a velocity to a valid range
     * @param velocity The input velocity
     * @return The velocity bound from (-100, 100), (-200, 200), (-600, 600)
     *         depending on the gearset
     */
    double bindVelocity(double velocity);
